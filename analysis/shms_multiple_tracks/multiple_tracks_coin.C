...
void multiple_tracks_coin() {
    // ------------------------------------------------------------------------
    // 0) Load our data and cuts
    CTData *data = new CTData("/home/jmatter/ct_scripts/ct_shms_singles_data.json");
    CTCuts *cuts = new CTCuts("/home/jmatter/ct_scripts/cuts.json");

    // Get TChains
    TChain* pionTree  = data->GetChain("C12_Q2_14_pion");
    TChain* largeTree = data->GetChain("C12_Q2_14_large");
