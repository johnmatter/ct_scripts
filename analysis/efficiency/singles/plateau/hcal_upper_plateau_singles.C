...
void hcal_upper_plateau_singles() {
    ...
    cHcal->Print("hcal_upper_plateau_singles.pdf["); // open PDF
    ...
    legLH2->Draw();
    cHcal->Print("hcal_upper_plateau_singles.pdf"); // write page to PDF
    ...
    cHcal->Print("hcal_upper_plateau_singles.pdf]"); // close fPDF
}
