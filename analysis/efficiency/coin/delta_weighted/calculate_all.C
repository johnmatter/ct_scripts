...
int main() {
    ...
    TString csvFilename = "by_kinematics/ct_event_weighted_efficiency.csv";
    TString pdfFilename = "by_kinematics/ct_event_weighted_efficiency.pdf";
    TString csvPerBinFilename = "by_kinematics/ct_event_weighted_efficiency_per_bin.csv";
